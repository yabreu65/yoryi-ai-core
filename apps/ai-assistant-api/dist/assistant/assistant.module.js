...
exports.AssistantModule = AssistantModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [assistant_service_1.AssistantService, assistant_auth_guard_1.AssistantAuthGuard, assistant_auth_config_service_1.AssistantAuthConfigService],
        exports: [assistant_auth_config_service_1.AssistantAuthConfigService],
    })
], AssistantModule);
