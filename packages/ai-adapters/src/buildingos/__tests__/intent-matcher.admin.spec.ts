...
const ADMIN_MATCHER_CASES: AdminMatcherCase[] = [
  ...
  { id: "ADM-010", question: "distribucion de deuda 0 30 31 60 61 90 90 mas", expectedIntent: "DEBT_AGING_BY_BUILDING", minConfidence: 0.85 },
  { id: "ADM-011", question: "ultimo pago recibido global del edificio", expectedIntent: "COLLECTION_EFFICIENCY", minConfidence: 0.85 },
  { id: "ADM-012", question: "ultimo pago confirmado en torre a", expectedIntent: "COLLECTION_EFFICIENCY", minConfidence: 0.85 },
  ...
  { id: "ADM-019", question: "comparar torre a vs torre b en morosidad y cobro", expectedIntent: "GET_COLLECTION_RATE_TREND", minConfidence: 0.85 },
...
describe("Intent matcher ADMIN coverage", () => {
  it("matches 20 ADMIN payment cases (aggregated/tower/period)", () => {
