...
const LEGACY_EXPECTATION_OVERRIDES: Record<string, QaExpected> = {
  ...
  "PAY-ADM-051": { matchType: "answer", intentCode: "COLLECTION_EFFICIENCY", level: "P0", minConfidence: null, missingEntities: [], toolName: "search_payments", fallbackPath: "intent_library_tool_success" },
  "PAY-ADM-052": { matchType: "answer", intentCode: "COLLECTION_EFFICIENCY", level: "P0", minConfidence: null, missingEntities: [], toolName: "search_payments", fallbackPath: "intent_library_tool_success" },
  "PAY-ADM-053": { matchType: "answer", intentCode: "COLLECTION_EFFICIENCY", level: "P0", minConfidence: null, missingEntities: [], toolName: "search_payments", fallbackPath: "intent_library_tool_success" },
  "PAY-ADM-054": { matchType: "no_match", intentCode: null, level: null, minConfidence: null, missingEntities: [], toolName: null, fallbackPath: "intent_library_no_match" },
  "PAY-ADM-056": { matchType: "answer", intentCode: "COLLECTION_EFFICIENCY", level: "P0", minConfidence: null, missingEntities: [], toolName: "search_payments", fallbackPath: "intent_library_tool_success" },
  "PAY-ADM-057": { matchType: "answer", intentCode: "COLLECTION_EFFICIENCY", level: "P0", minConfidence: null, missingEntities: [], toolName: "search_payments", fallbackPath: "intent_library_tool_success" },
  "PAY-ADM-058": { matchType: "no_match", intentCode: null, level: null, minConfidence: null, missingEntities: [], toolName: null, fallbackPath: "intent_library_no_match" },
  "PAY-ADM-059": { matchType: "answer", intentCode: "COLLECTION_EFFICIENCY", level: "P0", minConfidence: null, missingEntities: [], toolName: "search_payments", fallbackPath: "intent_library_tool_success" },
  ...
  "PAY-ADM-078": { matchType: "answer", intentCode: "COLLECTION_EFFICIENCY", level: "P0", minConfidence: null, missingEntities: [], toolName: "search_payments", fallbackPath: "intent_library_tool_success" },
  "PAY-ADM-079": { matchType: "clarification", intentCode: "COLLECTION_EFFICIENCY", level: "P0", minConfidence: null, missingEntities: ["buildingId"], toolName: "search_payments", fallbackPath: "intent_library_clarification" },
